...
<?php
   ...
   if (isset($_GET['id_santri'])) {
      $id_santri=input($_GET["id_santri"]);
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id_santri=htmlspecialchars($_POST["id_santri"]);
      $nis=input($_POST["nis"]);
 ...
 <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
            ...
            <select name="id_kelas" class="form-control"><form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <option selected disabled>-- Pilih --</option>
                ...
                <option value="I Wustha">I</option>
